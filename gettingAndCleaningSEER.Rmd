---
title: "Getting and cleaning SEER data"
...
SEER provides their data in a couple of different ways. We'll focus on downloading and cleaning binary data. 
...
This next command will create a dataframe that only extracts those variables that we want. It was intended to allow the user to select variables of interest, allowing for faster and more streamlined work. I used this package with the intention of exploring the data, so the following command will select all variables for importation. 
